...
const CardData = [
  ...
  {
    title: "Midinght Prayer - Fire Night (via Zoom)",
    description: "Join in our worship service every Sunday",
            ...
            <div className="flex gap-2 px-4 py-6">
              ...
              <div className="flex flex-col  gap-2">
                ...
                <div className="space-y-1">
                  {card.time.USA && (
                    <p className="text-primary-900 text-xs sm:text-sm font-bold border-b pb-2">
                      {`Restoration Chapel - USA: ${card.time.USA}`}
                    </p>
                  )}
                  {card.time.owerri && (
                    <p className="text-primary-900 text-xs sm:text-sm font-bold">
                      {`Restoration Chapel - Owerri: ${card.time?.owerri}`}
                    </p>
                  )}
                </div>
              </div>
