...
export function AboutDescription() {
  ...
  return (
    ...
    >
      <div className="container-max w-full grid grid-cols-1 lg:grid-cols-2 gap-12 p-12">
        <motion.div
        ...
        >
          <Image
            src={"/about/IMG-20250825-WA0080.jpg"}
            alt="About Image"
            width={500}
            height={800}
        ...
        <motion.div
          ...
          animate={isInView ? { x: 0, opacity: 1 } : { x: 50, opacity: 0 }}
          transition={{ duration: 0.5 }}
          className="w-full h-full flex flex-col items-center lg:items-end justify-center text-justify"
        >
